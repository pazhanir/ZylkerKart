package com.zylker.ecommerce.commondataservice.dao.sql.info.impl;

import com.zylker.ecommerce.commondataservice.dao.sql.info.queryhelpers.ProductQueryHelper;
import com.zylker.ecommerce.commondataservice.dao.sql.info.queryhelpers.context.ParamsToQueryContext;
import com.zylker.ecommerce.commondataservice.dto.*;
...
import com.zylker.ecommerce.commondataservice.utils.resulttransformers.ListResultTransformer;
...
public class ProductInfoRepositoryImpl {
        ...
        public Pair<Long, List<ProductInfo>> getProductsByCategories(HashMap<String, String> conditionMap) {
                ...
                TypedQuery<Long> totalCountQuery = entityManager.createQuery(
                ...
                if (totalCountQueryResultList != null && totalCountQueryResultList.get(0) > 0) {
                        ...
                        TypedQuery<ProductInfo> query = entityManager.createQuery(
                                        "select p from ProductInfo p where "
                                                        + String.join(" AND ", conditions) + sortBy,
                                        ProductInfo.class);
        ...
        private ParamsToQueryContext filterAndGetConditionMap(ProductQueryHelper productQueryHelper,
                ...
                if (conditionMap.containsKey(queryParam)) {
                        ...
                        if (!filterConditionMap.containsKey("brands") && !filterConditionMap.containsKey("genders")
                                        && !filterConditionMap.containsKey("apparels")
                                        && !filterConditionMap.containsKey("prices")) {
                ...
                if (filterConditionMap != null) {
                        paramsToQueryContext = productQueryHelper
                                        .getParamsToQueryMap((HashMap<String, String>) filterConditionMap);
                } else {
        ...
        public FilterAttributesResponse getFilterAttributesByProducts(HashMap<String, String> conditionMap) {
                ...
                List<FilterAttributesWithTotalItemsDTO> brandList = listResultTransformer
                                .getFilterAttributesWithTotalItemsResultTransformer(
                                                "SELECT p.productBrandCategory.id, p.productBrandCategory.type, count(*) as totalItems "
                                                                +
                                                                "from ProductInfo p where " +
                                                                String.join(" AND ",
                                                                                paramsToQueryContext.getConditions())
                                                                +
                ...
                List<FilterAttributesWithTotalItemsDTO> genderList = listResultTransformer
                                .getFilterAttributesWithTotalItemsResultTransformer(
                ...
                List<FilterAttributesWithTotalItemsDTO> apparelList = listResultTransformer
                                .getFilterAttributesWithTotalItemsResultTransformer(
                ...
                List<FilterAttributesWithTotalItemsDTO> priceList = listResultTransformer
                                .getFilterAttributesWithTotalItemsResultTransformer(
